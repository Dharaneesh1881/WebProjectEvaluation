...
router.post('/', requireAuth, requireRole('teacher'), async (req, res) => {
  const { title, description, files: incomingFiles, functionalityTests, interactionTests } = req.body;
...
router.get('/', requireAuth, async (req, res) => {
  const assignments = await Assignment.find({ isActive: true })
    .select('_id title description referenceScreenshotUrl referenceScreenshots referencePageScreenshots createdBy createdAt')
    .sort({ createdAt: -1 });
